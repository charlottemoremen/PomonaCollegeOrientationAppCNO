 ...
 * @author Shai Almog
 */
public class PomonaCollegeOrientationAppStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "PomonaCollegeOrientationApp";
    ...
    private PomonaCollegeOrientationApp mainApp;
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new PomonaCollegeOrientationAppStub());
    }
        ...
        Display.getInstance().callSerially(new Runnable() {
            ...
            public void run() {
                if(Display.getInstance().isEdt()) {
                    mainApp = new PomonaCollegeOrientationApp();
                    mainApp.init(this);
                    mainApp.start();
